...
<body>
	...
	<div align="center">
		...
		<s:form action="UpdateDoctors" class="formTable">
			<s:textfield name="idDoctor" label="Doctor Id" class="formTextField" readonly="true"/>
			...
			<s:submit value="Update Doctor" class="actionBtn"/>
		</s:form>
	</div>
